...
static void *init(xpl_context_t *self) {
    ...
    text = xpl_text_buffer_new(128, 128, 1);
    xpl_markup_clear(&markup);
    xpl_markup_set(&markup, "Candela", 60.f, TRUE, TRUE, xvec4_set(0.f, 0.f, 0.4f, 1.f), xvec4_all(0.0f));
    markup.outline = xfo_none;
    ...
    xmat4_ortho(0.f, 1280.f, 0.f, 720.f, 1.f, -1.f, &ortho_mvp);
