...
#define ini_openread(filename,file)   ((*(file) = _tfopen((filename),_TEXT("rb"))) != NULL)
#define ini_openwrite(filename,file)  ((*(file) = _tfopen((filename),_TEXT("wb"))) != NULL)
...
#define ini_ftoa(string,value)        _stprintf((string),_TEXT("%f"),(value))
#define ini_atof(string)              (INI_REAL)_tcstod((string),NULL)
#define ini_toupper(x)				  _totupper(x)
